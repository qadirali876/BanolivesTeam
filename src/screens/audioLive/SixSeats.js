...
const seatsFour = ['01', '02', '03', '04', '05', '06'];
    ...
    const renderView = ({ item, index }) => {
        return (
            index == 0 ?
                ...
                <View style={{}}>
                    <View style={{ marginVertical: 10, borderRadius: 10, marginHorizontal: 8, height: 140, width: 95 }} >
                        ...
                        <Image source={require('../../assets/images/audioLiveImgs/fourseatImage.png')} style={{ height: 140, width: 95, borderRadius: 10 }} />
                ...
                <View style={{}}>
                    ...
                    <View style={{ marginVertical: 10, borderRadius: 15, marginHorizontal: 5, height: 140, width: 98, backgroundColor: '#242A38', justifyContent: 'center', alignItems: 'center' }} >
